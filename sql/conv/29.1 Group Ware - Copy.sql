...
CONVERT(VARCHAR(MAX),CONVERT(VARBINARY(max),convert(varchar(max),WMESSAGE))),null,BEGINTIME,WFROM,WTO,0,0,u1.usrnUserID,mr.DATECREATED,u2.usrnUserID,mr.DATEREVISED,''
